...
export default function Navbar({ settings }: NavbarProps) {
  ...
  return (
    <nav className="p-4 md:px-6" aria-label="Main">
      <div
      ...
      >
        ...
        <div
          className={clsx(
            'fixed bottom-0 left-0 right-0 top-0 z-40 flex flex-col items-end gap-4 bg-[#070815]',
            'pr-4 pt-14 transition-transform duration-300 ease-in-out motion-reduce:transition-none md:hidden',
